...
if a12 < 0.5:
    print(f"In {((1 - a12) * 100):.1f}% of cases, Group 1: {file1} tends to have lower (better) values")
elif a12 > 0.5:
    print(f"In {(a12 * 100):.1f}% of cases, Group 2: {file2} tends to have lower (better) values")
else:
...
# Print results
print("Comparing elements at the same position in both arrays:")
print("Items in first array were:")
