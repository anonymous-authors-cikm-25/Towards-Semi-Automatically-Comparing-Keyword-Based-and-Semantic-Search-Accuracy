...
def process_documents(documents):
    ...
    for doc in documents:
        processed_document = extract_content_and_metadata(doc)
        all_processed_documents.extend(processed_document)
...
if __name__ == "__main__":
    ...
    processed_documents = process_documents(confluence_data)
    save_documents_in_json_file(processed_documents, document_name_processed)
